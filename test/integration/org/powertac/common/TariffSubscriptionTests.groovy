...
class TariffSubscriptionTests extends GroovyTestCase 
{
  ...
  void testConsumption ()
  {
    ...
    ttx = TariffTransaction.findByPostedTimeAndTxType(timeService.currentTime, TariffTransaction.TxType.CONSUME)
  ...
  void testProduction ()
  {
    ...
    ttx = TariffTransaction.findByPostedTimeAndTxType(timeService.currentTime, TariffTransaction.TxType.PRODUCE)
