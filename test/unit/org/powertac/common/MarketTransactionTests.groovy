...
class MarketTransactionTests extends GrailsUnitTestCase {
  ...
  void testNullableValidationLogic() {
    ...
    assertEquals('nullable', transactionLog.errors.getFieldError('postedTime').getCode())
    //assertEquals('nullable', transactionLog.errors.getFieldError('transactionId').getCode())
  }

  //void testQuoteValidationLogic() {
  //  MarketTransaction transactionLog = new MarketTransaction(transactionType: MarketTransactionType.QUOTE, price: 1.0, quantity: 10.0, buyer: broker, seller: broker, buySellIndicator: BuySellIndicator.BUY)
  //  mockForConstraintsTests(MarketTransaction, [transactionLog])
  //  assertFalse (transactionLog.validate())
  ...
  //  MarketTransaction transactionLog = new MarketTransaction(transactionType: MarketTransactionType.TRADE, bid: 1.0, bidSize: 10.0, ask: 1.0, askSize: 10.0)
  //  mockForConstraintsTests(MarketTransaction, [transactionLog])
  //  assertFalse (transactionLog.validate())
