 ...
 */
  ...
  static hasMany = [brokers: Broker, orderbooks: Orderbook, positionUpdates: PositionUpdate, products: Product, shouts: Shout, timeslots: Timeslot, transactionLogs: TransactionLog, tariffs: Tariff, customers: CustomerInfo]
